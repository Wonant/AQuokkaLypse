...
public class GDXRoot extends Game implements ScreenListener {
    ...
    private String[] maps = {"platform-constants", "platform-constants", "platform-constants1", "platform-constants2"};
    private String[] tiled = {"maps/tutorial_2.tmx", "maps/tutorial1.tmx", "maps/tutorial2.tmx", "maps/easy_level.tmx"};
